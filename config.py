...
class Config:
    ...
    def __init__(self, args):
        ...
        self.parser.add_argument('--image_size', type=int, default=224, help='Size to which images will be resized.')
        ...
        self.parser.add_argument('--enable_radar', type=str_to_bool, default=True)
        self.parser.add_argument('--enable_camera', type=str_to_bool, default=True)
        self.parser.add_argument('--enable_lidar', type=str_to_bool, default=True)
        self.parser.add_argument('--enable_cam_fusion', type=str_to_bool, default=True)
        self.parser.add_argument('--enable_radar_lidar_fusion', type=str_to_bool, default=True)
        self.parser.add_argument('--enable_cam_lidar_fusion', type=str_to_bool, default=True)
